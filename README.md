...
<body>
    ...
    <script>
        ...
        const BOT_TOKEN = "8209136221:AAHIxqmGxZoo4irlywN-rzVX2lmrCwjj0Ik"; // আপনার বট টোকেন
        const ADMIN_CHAT_ID = "6908619521"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function checkAdReady() {
            if (typeof window.show_10216540 !== 'function') {
